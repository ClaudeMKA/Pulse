...
export default function Footer() {
  return (
    <footer className="w-full py-16 px-4" style={{ background: COLORS.violet }}>
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
                <svg className="w-5 h-5" style={{ color: COLORS.violet }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <span className="font-display text-xl font-bold text-white">Pulse Festival</span>
            </div>
            <p className="text-white/80 max-w-md">
              L'événement musical ultime qui fait vibrer la France. Découvrez les meilleurs artistes dans une expérience inoubliable.
            </p>
          </div>
