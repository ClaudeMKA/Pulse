  ...
  const handleReservation = async () => {
    ...
    try {
      if (event.price && event.price > 0) {
        // Événement payant - rediriger vers le système Stripe
            ...
            >
              ...
              <div className="mt-8">
                <button
                  ...
                  className="w-full px-6 py-4 rounded-2xl text-white font-bold text-lg hover:opacity-90 transition-all duration-300 transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                ...
                >
                  {isRegistering ? (
                    ...
                    <>
                      🎫 {event.price && event.price > 0 ? `Réserver pour ${event.price}€` : "S'inscrire gratuitement"}
                    </>
                  )}
                </button>
